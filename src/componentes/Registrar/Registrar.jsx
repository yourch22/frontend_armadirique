...
const Registrar = () => {
  ...
  const styles = {
    ...
    formInput: (focused, hasError) => ({
      ...
      fontSize: '1.1rem',
      transition: 'all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
      background: hasError ? 'rgba(255, 107, 107, 0.05)' : focused ? 'rgba(255, 255, 255, 0.98)' : 'rgba(255, 255, 255, 0.8)',
    ...
    submitButton: (isSubmitting) => ({
      width: '100%',
      padding: '1.5rem 2rem',
      background: isSubmitting ? 'linear-gradient(135deg, #999, #666)' : 'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%)',
      color: 'white',
      border: 'none',
      borderRadius: '20px',
      fontSize: '1.2rem',
  ...
  const keyframes = `
    ...
    @media (max-width: 768px) {
      ...
      .form-card { padding: 2rem 1.5rem !important; margin: 1rem !important; }
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          <div style={styles.headerContent}>
            ...
            <h1 style={styles.brandTitle}>ARMADIRIQUE</h1>
          ...
          <div style={styles.formContainer}>
            <div style={styles.formCard}>
              <div style={styles.formHeader}>
                ...
                <p style={styles.formSubtitle}>Complete todos los campos para registrarse</p>
              </div>

              {generalError && (
                <div style={styles.errorAlert}>{generalError}</div>
              )}

              <form onSubmit={handleSubmit}>
                {/* Información Personal */}
                <div style={{...styles.formSection, animationDelay: '0.1s'}}>
                ...
                <div style={{...styles.formSection, animationDelay: '0.2s'}}>
                  <div style={styles.sectionHeader}>
                    <span style={styles.sectionIcon}>📧</span>
                ...
                <div style={{...styles.formSection, animationDelay: '0.3s'}}>
                  <div style={styles.sectionHeader}>
                    <span style={styles.sectionIcon}>📱</span>
                  ...
                  <div style={styles.formGroup}>
                    <label style={styles.formLabel}>Teléfono (Perú) *</label>
                    <div style={styles.inputWrapper(focusedField === "telefono", errors.telefono)}>
                      <div style={styles.phoneWrapper(focusedField === "telefono", errors.telefono)}>
                        <span style={styles.countryCode}>+51</span>
                        <input
                          type="tel"
                          name="telefono"
                ...
                <div style={{...styles.formSection, animationDelay: '0.4s'}}>
                  <div style={styles.sectionHeader}>
                    <span style={styles.sectionIcon}>📍</span>
                    <h3 style={styles.sectionTitle}>Información de Ubicación</h3>
                  </div>
                ...
                {/* Seguridad */}
                <div style={{...styles.formSection, animationDelay: '0.5s'}}>
                  <div style={styles.sectionHeader}>
                    <span style={styles.sectionIcon}>🔒</span>
